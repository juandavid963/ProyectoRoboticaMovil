...
whos f  % nombre, tamaño, bytes, clase
...
vidobj=videoinput('winvideo',1,'RGB24_640x480'); % con formato
...
delete(vidobj)
        ...
        %umb=graythresh(img_gris); % umbral automatico
        %imcontour(bw,3)
        %imhist(img_gris) % crear un histograma